        ...
        <AnimationWrapper>
          ...
          profile_username.length ? 
            <section className="h-cover md:flex flex-row-reverse items-start gap-5 min-[1100px]:gap-12">
              <div className="flex flex-col max-md:items-center gap-5 min-2-[250px] md:w-[50%] md:pl-8 md:border-l border-border md:top-[100px] md:py-10">
                ...
                <p className="text-muted-foreground">{total_posts.toLocaleString()} Blogs · {total_reads.toLocaleString()} Reads</p>
                <div className="flex gap-4 mt-2">

                  {
                    profileId == username ? <Button asChild variant="light" size="sm">
