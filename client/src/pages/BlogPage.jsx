...
const BlogPage = () => {
    ...
    const fetchBlog = () => {
      ...
      axios.post(import.meta.env.VITE_HOST + '/get-blog',{blog_id})
      ...
      .then(async({data:{blog}})=>{
        ...
        axios.post(import.meta.env.VITE_HOST + '/search-blog',{tag:blog.tags[0],limit:6,eliminate_blog:blog_id})
    ...
    return (
      ...
      <AnimationWrapper>
        ...
        {loading ? <Loader/> : 
          ...
          <BlogContext.Provider value={{blog,setBlog,likedByUser,setLikedByUser,commentsWrapper,setCommentsWrapper,totalParentCommentsLoaded,setTotalParentCommentsLoaded}}>
