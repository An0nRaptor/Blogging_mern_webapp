...
import AnimantionWrapper from "../common/PageAnimation";
...
const ChangePassword = () => {
    ...
    const handleSubmit=(e)=>{
        ...
        axios.post(import.meta.env.VITE_HOST + '/change-password',formData,{
            ...
            <form ref={changePasswordForm}>
                ...
                <div className="py-10 w-full md:max-w-[400px]">
                    <InputBox name="currentPassword"
                     type="password" className="profile-edit-input"
                      placeholder="Current Password" icon="fi-rr-unlock" />
                      <InputBox name="newPassword"
                     type="password" className="profile-edit-input"
                      placeholder="New Password" icon="fi-rr-unlock" />
